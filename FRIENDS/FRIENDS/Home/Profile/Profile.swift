...
struct Profile: View {
    ...
    @State private var sub: Bool = false
        ...
        VStack {
            HStack {
                ...
                .sheet(isPresented: $showSetting, content: {
                    ...
                    Section("Notications") {
                        Toggle("Enable Notifcations", isOn: $sub)
                            .tint(.blue)
                    }
                    .frame(maxWidth: .infinity, alignment: .leading)
                    .padding()
...
#Preview {
    Profile(allUsers: [], logedin:   [User(fristName: "Amanda", lastNane: "Davis", userName: "Panda44", email: "amandadavis@icloud.com",  city: "San Franscisco")])
}
        ...
        NavigationView {
            ZStack {
                ...
                .sheet(isPresented: $postView, content: {
                    ...
                    .padding()
                    .frame(maxWidth: .infinity, alignment: .leading)
                    Post(name: userName, city: "",   likes: likes, comments: comments, postPics: [""], profilePic: Image("SF"), showLike: isLiked, caption: "")
                })
            }
        }
    }
